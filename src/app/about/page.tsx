        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="font-sans text-4xl md:text-6xl font-light tracking-tight mb-8">
              Building products that <span className="italic">matter</span>
            </h1>
          </motion.div>
              ...
              {[
                {
                  ...
                  description: "A lot of devs forget about concepts like performance. This is a great course to refresh yourself:",
                  link: {
                ...
                },
                {
                  ...
                  description: "x402 is one example, btw I built the website: ",
                  link: {
                    url: "https://x402.org",
                    text: "x402.org"
                  }
                },
                {
                  ...
                  description: "Genuinely surprised at this.",
                },
              ].map((value, index) => (
                <motion.div
                  key={value.title}
                ...
                >
                  <h3 className="font-mono text-accent mb-2">{value.title}</h3>
